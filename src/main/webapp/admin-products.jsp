                    ...
                    <table class="table-shopping-cart">
                        ...
                        <c:forEach items="${products}" var="product">
                            <tr class="table_row" id="prod-${product.productId}">
                                ...
                                <td class="column-2"><c:out value="${product.name}"/></td>
                                <td class="column-3">$ <c:out value="${product.price}"/></td>
                                <td class="column-4">
                                    <span class="badge ${product.quantity > 10 ? 'badge-success' : 'badge-warning'} p-lr-10 p-tb-5"><c:out value="${product.quantity}"/></span>
                                </td>
                                <td class="column-5">
                                    <button class="stext-106 cl6 hov1 bor3 trans-04 p-lr-15 p-tb-5 m-r-10 text-primary js-edit-product"
                                    ...
                                    <button class="stext-106 cl6 hov1 bor3 trans-04 p-lr-15 p-tb-5 text-danger js-remove-product"
                        ...
                        <form id="productForm" action="admin-product" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6 bor8 m-b-20 how-pos4-parent">
                                    <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="text" id="pName" name="name"
                                        placeholder="Product Name" required>
                                </div>
                                <div class="col-sm-6 bor8 m-b-20 how-pos4-parent">
                                    <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="text" id="pBrand" name="brand"
                            ...
                            <div class="row">
                                <div class="col-sm-6 bor8 m-b-20 how-pos4-parent">
                                    <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="number" id="pPrice" name="price"
                                        placeholder="Price ($)" required min="0" step="0.01">
                                </div>
                                <div class="col-sm-6 bor8 m-b-20 how-pos4-parent">
                                    <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="number"
                                        id="pQuantity" name="quantity" placeholder="Quantity In Stock" required min="0">
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-sm-4 bor8 m-b-20">
                                    <select class="stext-111 cl2 plh3 size-116 p-l-20" id="pCategory" name="category" required>
                                ...
                                <div class="col-sm-4 bor8 m-b-20">
                                    <select class="stext-111 cl2 plh3 size-116 p-l-20" id="pGender" name="gender" required>
                                ...
                                <div class="col-sm-4 bor8 m-b-20">
                                    <select class="stext-111 cl2 plh3 size-116 p-l-20" id="pAge" name="age" required>
                            ...
                            <div class="bor8 m-b-20 how-pos4-parent">
                                <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="file" id="pImageFile" name="imageFile"
                                       accept="image/jpeg,image/png" required>
                            </div>

                            <div class="bor8 m-b-30">
                                <textarea class="stext-111 cl2 plh3 size-120 p-lr-20 p-tb-25" id="pDesc" name="description"
