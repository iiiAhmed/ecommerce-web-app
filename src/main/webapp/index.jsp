<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<body class="animsition">
		...
		<header>
			...
			<div class="menu-mobile">
				<ul class="main-menu-m">
					...
					<c:choose>
						<c:when test="${not empty sessionScope.userDto}">
							<li><span class="stext-106 cl2">Welcome, ${sessionScope.userDto.name}</span></li>
							<c:if test="${sessionScope.userDto.role == 'ADMIN'}">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<div class="block2-qty flex-c-m trans-04">
									...
									<button type="button" class="block2-qty-btn" onclick="changeQty(this, 1)">+</button>
								</div>
							</div>

							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="product.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										Esprit Ruffle Shirt
									</a>
		...
		<script>
			// BONUS: Search input mockup logic via jQuery Isotope (existing in template) augmented
			$('input[name="search-product"]').on('keyup', function (e) {
				const val = $(this).val().toLowerCase();
				$('.isotope-item').each(function () {
					const title = $(this).find('.js-name-b2').text().toLowerCase();
			...
			$('.js-addcart-detail').on('click', function () {
				...
				setTimeout(() => {
					// Change heart icon via existing SWAL behavior naturally handled by Cozastore main.js if we don't return early
					swal(nameProduct, "is added to cart ! (AJAX saved)", "success");
					btn.text('Add to cart').css('pointer-events', 'auto');
