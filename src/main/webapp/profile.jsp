...
<head>
    ...
    <style>
        ...
        /* The tick box shown inside the pill */
        .interest-label .check-icon {
            ...
            font-size: 13px;
            font-weight: 900;
            color: transparent;  /* hide tick by default */
            line-height: 1;
        }
        /* When checkbox is checked — fill box and show tick */
        .interest-label input:checked ~ .check-icon {
            background: #717fe0;
            border-color: #717fe0;
            color: #ffffff;      /* white tick visible */
        }
        .interest-label input:checked ~ .check-icon::after {
            content: '\2714'; /* ✔ heavy checkmark */
        }
        /* Pill border + text color when checked */
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.userDto}">
                                ...
                                <a href="logout" class="stext-106 cl2 hov-cl1 trans-04 p-l-22 p-r-11">Sign Out</a>
                            </c:when>
                            <c:otherwise>
                                <a href="sign-in.html" class="stext-106 cl2 hov-cl1 trans-04 p-l-22 p-r-11">Sign In</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </nav>
